...
- adresine gidiyoruz cüzdanımızı bağlıyoruz. Ağı otomatik ekler. sonra herhangi ufak bir resim dosya seçiyoruz ve upload edip, onay verıyoruz.

![image](https://github.com/Core-Node-Team/Testnet-TR/assets/91562185/36d5d3ee-85a2-4d7a-ae56-8784b0fa8c1c)


### Kendine delege
NOT: wallet kısmına cuzdan adı yazınız. 
```bash
